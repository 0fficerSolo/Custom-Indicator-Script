...
RegisterNetEvent('solo:syncIndicator')
AddEventHandler('solo:syncIndicator', function  (playerId, IStatus)
...
AddEventHandler('solo:setIndicator', function (IStatus)
...
RegisterNetEvent('solo:syncHazards')
AddEventHandler('solo:setHazards', function(hazardsDeactivate)
    ...
    if ped ~= nil then
        ...
        TriggerServerEvent("solo:syncIndicator", indicator)
        TriggerEvent("solo:setIndicator", indicator)
    end
end)
